...
- **色彩**：底色 `#fafaf6` 纸白 + 顶栏 `#f5f0eb` 米灰 + 朱砂红 `#b8403e` 仅 CTA 按钮
- **图标**：22 枚单色 SVG 线框（`components/icons.tsx`），`stroke:#666`，20px
- **排版**：`letter-spacing: 0.02em`，标题 500-weight，正文 400
- **卡片**：无阴影，`border-radius: 0`，细线分隔
- **按钮**：无圆角，仅主 CTA 用暗朱砂，其余线框
